	...
	<div class="big-form__items">
		...
		<div class="big-form__item">
			<div class="input-box form__box">
				...
				<input class="input date-input" name="deadline" placeholder="<?php echo date('F, j'); ?>" id="date-popup" type="text" onfocus="(this.value='<?php echo date('d.m.Y'); ?>')" readonly autocomplete="off" required>
				<label class="date-img" for="date-popup"></label>
			</div>
			<div class="input-box form__box">
				<span class="input-box__text">
					Seitenanzahl
